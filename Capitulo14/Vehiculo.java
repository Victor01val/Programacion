...
// La clase abstracta VehiculoTerrestre extiende Vehiculo y agrega un atributo
// numRuedas y un metodo getNumRuedas
...
// La clase abstracta VehiculoAcuatico extiende Vehiculo y agrega un atributo
// eslora y un metodo getEslora()
...
// La clase VehiculoAereo extiende Vehiculo y agrega un atributo numAsientos y
// el metodo getnumAsientos()
...
class Helicoptero extends VehiculoAereo { // La clase Helicoptero extiende VehiculoAereo y agrega un atributo numHelices
                                          // y el metodo
...
class Avion extends VehiculoAereo { // La clase Avion extiende VehiculoAereo y agrega un atributo tiempoMaximoVuelo
                                    // y el metodo
...
class Submarino extends VehiculoAcuatico { // La clase Submarino extiende VehiculoAcuatico y agrega un atributo
                                           // profundidadMaxima y el metodo
...
class Coche extends VehiculoTerrestre { // La clase Coche extiende VehiculoTerrestre y agrega un atributo
                                        // aireAcondicionado y el metodo getaireAcondicionado
  ...
  public void imprimir() {
    System.out.println("Coche " + getModelo() + " con matrícula " + getMatricula() + ", " + getNumRuedas()
        + " ruedas y " + (aireAcondicionado ? "con aire acondicionado" : "sin aire acondicionado"));
  }
}

class Moto extends VehiculoTerrestre { // La clase Moto extiende VehiculoTerrestre y agrega un atributo color y el
                                       // metodo getColor
  ...
  public void imprimir() {
    System.out.println("Moto " + getModelo() + " de color " + color + " con matrícula " + getMatricula() + " y "
        + getNumRuedas() + " ruedas");
  }
}
